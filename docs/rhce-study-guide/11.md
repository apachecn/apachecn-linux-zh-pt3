...
非常感谢神奇的道格拉斯·亚当斯和《银河系漫游指南》，我们都知道 42 是终极答案——是生命、宇宙和一切的意义。我恭敬地建议这现在可能是Ansible，在这一章中，我希望用一个使用自动化我们能实现多少的演示来说服你。我们已经使用了 Ansible 中许多我们需要知道的工具和元素，这意味着我们可以从一些更强大的东西开始。我们将解决安装 Apache 时需要做的所有事情，并让 Ansible 在 Ubuntu 和 CentOS Linux 发行版上实现自动化。
