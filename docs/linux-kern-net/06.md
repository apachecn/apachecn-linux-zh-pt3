...
![9781430261964_Fig06-01.jpg](images/9781430261964_Fig06-01.jpg)
...
2.  *IGMPv2 (RFC 2236)**:* This is an extension of IGMPv1\. The IGMPv2 protocol adds three new messages:
    ...
    ![image](images/sq.jpg) **注意** IGMPv2 也支持版本 1 成员报告消息，以向后兼容 IGMPv1。参见 RFC 2236 第 2.1 节。
...
![image](images/sq.jpg) **注**IP v4 IGMP 的内核实现在`net/core/igmp.c`、`include/linux/igmp.h`、`include/uapi/linux/igmp.h`。
...
![image](images/sq.jpg) **注** IPv4 组播路由在`net/ipv4/ipmr.c`、`include/linux/mroute.h`、`include/uapi/linux/mroute.h`实现。
...
![image](images/sq.jpg) **注意**多路径路由支持需要设置 CONFIG_IP_ROUTE_MULTIPATH。
