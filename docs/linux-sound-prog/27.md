...
FluidSynth 是一个播放 MIDI 文件的应用程序，也是一个 MIDI 应用程序库。它没有播放卡拉 ok 文件的挂钩。本章讨论了对 FluidSynth 的一个扩展，该扩展添加了适当的挂钩，然后使用这些挂钩来构建各种卡拉 ok 系统。
...
回调是在应用程序中注册的函数，当某些事件发生时被调用。要构建卡拉 ok 播放器，您需要了解以下内容:
...
![A435426_1_En_27_Fig1_HTML.jpg](A435426_1_En_27_Fig1_HTML.jpg)
...
![A435426_1_En_27_Fig2_HTML.jpg](A435426_1_En_27_Fig2_HTML.jpg)
