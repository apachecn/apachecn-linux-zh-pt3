...
要使用TiMidity向 ALSA 设备播放文件，请使用如下代码:
...
有几个关于编程 ALSA 的教程，包括保罗·戴维斯(他是Jack的领头人)的“使用 ALSA 音频 API 的教程”( [`http://equalarea.com/paul/alsa-audio.html`](http://equalarea.com/paul/alsa-audio.html) )。
